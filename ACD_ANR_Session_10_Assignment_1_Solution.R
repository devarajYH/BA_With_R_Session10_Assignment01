...
# Qn.1 Examine the following normal Quantile plots carefully. Which of these plots indicates 
#      that the data

# I. Are nearly normal?
# II. Have a bimodal distribution? (One way to recognize a bimodal 
#         shape is a "gap" in the spacing of adjacent data values.)
...
# III. Are skewed (i.e. not symmetric) ?
# Ans: A (Skewed Positively)

# IV. Have outliers on both sides of the center?
# Ans: B (Outliers are present on both sides of central axis)
  

#######################################################################################################

# Qn.2 For each of the following statements, indicate whether it is True/False. If false, explain why.
